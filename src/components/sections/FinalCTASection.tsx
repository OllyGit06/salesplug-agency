        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-xl lg:text-2xl opacity-90 max-w-3xl mx-auto leading-relaxed">
              Stop missing calls. Stop losing sales. Let Callsi work 24/7 to grow your business 
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <p className="text-lg font-semibold mb-2">Join 120,000+ Businesses Already Growing with Callsi</p>
            <p className="opacity-90">
              Don't let your competitors get ahead. Start automating your phone operations today 
              and see why Callsi is the #1 choice for AI telephony solutions.
            </p>
          </div>
        </div>
      </div>
